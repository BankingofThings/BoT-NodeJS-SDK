...
ConfigureCharacteristic.prototype.onWriteRequest = async (
    ...
    console.log('Bleno: ConfigureCharacteristic - onWriteRequest: value = ' +
        data.toString());
    ...
    if (offset > data.length) {
        ...
        if (details.Skip === true) {
            ...
            // Not calling PairingService.pair() here, will automatically run
            // on restart
            setTimeout(function () {
...
ConfigureCharacteristic.prototype.onReadRequest = (offset, callback) => {
    ...
    console.log('Bleno: DeviceCharacteristic - onReadRequest: value = ' +
